...
def main():
    ...
    # Define the output directory based on experiment type for health data
    health_save_path = os.path.join("Outputs", "health")
    if exp == 'diverse':
        experiment_save_path = os.path.join(health_save_path, "diverse")
    elif exp == 'repetitive':
        experiment_save_path = os.path.join(health_save_path, "repetitive")
    else:
